const CACHE_NAME = 'gazprom-web-v161';
...
const STATIC_ASSETS = [
  ...
  './js/violation-types-editor.js?v=2',
  './js/defaults-bootstrap.js?v=1',
  './js/violation-registry.js?v=9',
  './js/catalog-service.js',
  './js/backup-import.js?v=30',
  './js/akt-search.js',
  './js/ui-bindings.js?v=30',
