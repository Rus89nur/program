const CACHE_NAME = 'gazprom-web-v178';
...
const STATIC_ASSETS = [
  ...
  './js/toast.js',
  './js/mobile-overlay.js?v=33',
  './js/violation-search.js?v=3',
  './js/violation-templates.js',
  './js/violation-types.js?v=2',
  './js/violation-types-editor.js?v=5',
  './js/defaults-bootstrap.js?v=5',
  './js/violation-registry.js?v=12',
  './js/catalog-service.js',
  './js/backup-import.js?v=30',
  './js/akt-search.js',
  './js/ui-bindings.js?v=31',
