...
Актуальная сборка: **web-74** (в UI: **Главная** → внизу «Сборка: web-XX»; номер подставляется из `GAZPROM_WEB_BUILD` в `app.js`).
...
1. **Главная** → внизу по центру «Сборка: web-74» (после обновления страницы).
...
_Обновлено под web-74. При следующем релизе — синхронизировать номер сборки и §7._
